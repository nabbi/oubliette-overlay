...
if [[ ${PV} == 9999 || ${MY_PV_P} == 9999 ]]; then
	...
	MY_RTSP_V="24e6b7153aa561ecc4123cc7c8fc1b530cde0bc9"
...
IUSE="curl gcrypt +mmap mqtt vlc +${IUSE_WEB_SERVER}"
REQUIRED_USE="
	^^ ( ${IUSE_WEB_SERVER} )
"
...
src_configure() {
	...
	mycmakeargs=(
		...
		-DZM_NO_MQTT="$(usex mqtt OFF ON)"
		-DZM_JWT_BACKEND=jwt_cpp
		-DZM_CRYPTO_BACKEND=openssl
