...
PATCHES=(
	"${FILESDIR}/${PN}-2.10.3-openrc.patch"
	"${FILESDIR}/${PN}-pr126-ar-before-received-header.patch"
	"${FILESDIR}/${PN}-2.10.3-define-P-macro-in-libvbr.patch"
	"${FILESDIR}/${PN}-2.10.3-fix-libmilter-search.patch"
)
