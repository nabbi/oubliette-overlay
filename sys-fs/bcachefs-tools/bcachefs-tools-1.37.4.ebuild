...
# linux-mod-r1 EXPORT_FUNCTIONS pkg_postinst unconditionally, but the upstream
# ebuild never overrides it with a USE=modules guard. This causes the eclass to
# die when USE=-modules because linux-mod-r1_pkg_setup was never called.
pkg_postinst() {
