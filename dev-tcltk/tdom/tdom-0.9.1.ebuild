...
#tDOM - 0.9.1 2018-05-15 commit version
MY_PV="acce545518"
MY_P="tDOM-${MY_PV}"
...
SRC_URI="https://core.tcl.tk/tdom/tarball/${MY_PV}/${MY_P}.tar.gz"
...
#PATCHES=(
	...
	#"${FILESDIR}/"tdom-0.8.3-soname.patch
	#"${FILESDIR}/"tdom-0.8.3-expat.patch
